...
Decision requests isolate choices that block safe planning or implementation. They present the question, why it is needed now, viable options, constraints, consequences, affected contracts, and required approvers.

Name files `DEC-####-short-name.md` and start from [the decision-request template](../templates/decision-request-template.md).
